...
def _read_constants() -> tuple[str, int, int]:
    ...
    init_path = os.path.join(ROOT, "Content", "Python", "uefn_tools", "__init__.py")
...
SCAN_FILES = [
    ...
    "Content/Python/uefn_tools/dashboard_pyside6.py",
    "tests/smoke_test.py",
]
...
_SKIP_LINE_FRAGMENTS = [
    ...
    "integration test",
    "integration_test",
    "uefn_tools_smoke_test",
    "uefn_tools_integration_test",
