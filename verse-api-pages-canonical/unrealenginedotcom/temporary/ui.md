...
# cylinder class
Learn technical details about the cylinder class.
|
---|---
...
[`mesh_component`](https://dev.epicgames.com/documentation/fortnite/verse-api/versedotorg/scenegraph/mesh_component) |  Used to render a `mesh` at the location of this entity. A mesh is a set of polygons that can be used to represent shapes in the world such as:
...
---|---
[`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/versedotorg/scenegraph/mesh_component/disable) |  Disables rendering of this mesh.
[`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/versedotorg/scenegraph/mesh_component/enable) |  Enables rendering of this mesh.
[`IsEnabled`](https://dev.epicgames.com/documentation/fortnite/verse-api/versedotorg/scenegraph/mesh_component/isenabled) |  Succeeds if the component is enabled, fails if it's disabled.
