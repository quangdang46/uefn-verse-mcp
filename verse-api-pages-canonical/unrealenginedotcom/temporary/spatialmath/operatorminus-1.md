...
`operator'-'<public>(Left:vector2i, Right:vector2i)<computes>:`[`vector2i`](https://dev.epicgames.com/documentation/fortnite/verse-api/unrealenginedotcom/temporary/spatialmath/vector2i)
## Parameters
