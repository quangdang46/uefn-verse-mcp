...
`operator'*'<public>(Left:float, Right:vector2)<computes>:`[`vector2`](https://dev.epicgames.com/documentation/fortnite/verse-api/unrealenginedotcom/temporary/spatialmath/vector2)
## Parameters
