...
---|---
[`GetAlertLevel`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/ai/guard_awareness_component/getalertlevel) |  Get the current alert level for a specific target.
