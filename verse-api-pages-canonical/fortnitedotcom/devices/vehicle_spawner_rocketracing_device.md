...
[`Transmit`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/channel_device/transmit) |  Calls `ReceivedTransmitEvent`, optionally with `Agent` as the instigator.
