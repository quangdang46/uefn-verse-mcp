...
[`Seek`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/video_player_device/seek) |  Seeks to the _Triggered Seek Time_. Caution: The stream will pause while the video buffers when seeking.
...
[`TakeControl`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/video_player_device/takecontrol) |  Stops the currently playing stream and starts the custom stream with the audio only playing from this device. _Stream Priority_ will not work until control is released.
