...
---|---
[`Assign`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/ai_patrol_path_device/assign) |  Assign an AI to this patrol path.
[`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/ai_patrol_path_device/disable) |  Disables this device.
[`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/ai_patrol_path_device/enable) |  Enables this device.
...
[`GoToNextPatrolGroup`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/ai_patrol_path_device/gotonextpatrolgroup) |  Commands patroller to follow the _Next Patrol Path Group_ instead of the default _Patrol Path Group_.
