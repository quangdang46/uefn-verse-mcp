...
`MoveTo<public>(Transform:transform, OverTime:float)<transacts><suspends><no_rollback>:`[`move_to_result`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/move_to_result)
## Parameters
