...
[`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/npc_spawner_device/disable) |  Disables this device. Characters will despawn if _Despawn AIs When Disabled_ is set.
