...
---|---
[`ApplyAngularImpulse`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/creative_prop/applyangularimpulse) |  Apply an angular impulse to a ‘creative_prop’ with units in Newton _meter_ seconds. Will not do anything if physics is disabled.
