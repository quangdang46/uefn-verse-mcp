...
`NavigateTo<public><native>(Target:navigation_target, MovementType:movement_type, ReachRadius:float, AllowPartialPath:logic)<transacts><suspends><no_rollback>:`[`result(success_type,error_type)`](https://dev.epicgames.com/documentation/fortnite/verse-api/versedotorg/verse/result/result\(success_type,error_type\))
## Parameters
