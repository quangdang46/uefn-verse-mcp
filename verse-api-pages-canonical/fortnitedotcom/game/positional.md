...
---|---
[`SubscribeRoundStarted`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/game/fort_round_manager/subscriberoundstarted) |  Subscribed callbacks will be invoked in two scenarios:
