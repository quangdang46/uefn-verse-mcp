...
`operator'*'<public><native>(PreRotation:rotation, PostRotation:rotation)<reads>:`[`rotation`](https://dev.epicgames.com/documentation/fortnite/verse-api/versedotorg/spatialmath/rotation)
## Parameters
