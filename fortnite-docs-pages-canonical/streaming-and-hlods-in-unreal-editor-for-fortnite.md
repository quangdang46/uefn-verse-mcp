...
The Prop-O-Matic Manager can add [HUD messages](https://dev.epicgames.com/documentation/fortnite/fortnite-creative-glossary) to the screen to let players know when the next ping will occur, and when it occurs, it pings the location of players on the island.
