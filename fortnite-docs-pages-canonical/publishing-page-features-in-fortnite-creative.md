...
**Foliage Mode** provides a way to quickly create forests and woods on your terrain to make realistic-looking landscapes. Use the Foliage tools to determine how to add trees, bushes, flowers, and more to your project. This editing mode works with [Landscape Mode](https://dev.epicgames.com/documentation/fortnite/landscape-mode-in-unreal-editor-for-fortnite).
##  How It Works
...
Use Foliage Mode when [greyboxing](https://dev.epicgames.com/documentation/fortnite/greyboxing-in-unreal-editor-for-fortnite) your level to plan where you will place foliage. Create simple shapes with [Modeling Mode](https://dev.epicgames.com/documentation/fortnite/modeling-mode-in-unreal-editor-for-fortnite), then add the shapes to the Mesh List and paint the shapes onto the terrain to get an idea of how the foliage will look.
##  Foliage Tools
...
**Instance Settings** :
  ...
  * **Collision Presets** - Select collision presets. You can set this data in [Project Settings](https://dev.epicgames.com/documentation/fortnite/user-interface-reference-for-unreal-editor-for-fortnite).
