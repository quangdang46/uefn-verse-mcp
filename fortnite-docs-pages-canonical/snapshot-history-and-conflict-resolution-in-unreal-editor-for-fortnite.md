...
**Disable When Empty** |  On, **Off** |  This option only displays if the **Pool Type** option is set to **Device Inventory**. Determines whether the device is [disabled](https://dev.epicgames.com/documentation/fortnite/fortnite-creative-glossary) when all items have been caught. |
