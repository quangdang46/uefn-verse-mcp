...
![GOAT Getaway SDG Lesson Plan](https://dev.epicgames.com/community/api/documentation/image/ba21c0af-c8a3-46ad-bf20-5704bd3befc6?resizing_type=fill&width=1920&height=335)
...
_One GOAT Getaway solution uses Wood Shanty Stilt Houses in the resort area to preserve a local beach area and provide authentic local accommodations, (2) a Fortnite launch-pad "diving board", and (3) a village on a nearby island for the local residents._
This lesson asks students to consider the following:
  * How does the [design thinking](https://dev.epicgames.com/documentation/fortnite/fortnite-creative-glossary#design-thinking) process support creative problem solving?
...
Consider accounting for transportation, guests with disabilitities, and activities that would appeal to tourists. Use [prefabs](https://dev.epicgames.com/documentation/fortnite/fortnite-creative-glossary#prefab) that can be found in the [CREATIVE inventory](https://dev.epicgames.com/documentation/fortnite/fortnite-creative-glossary) under the [PREFABS tab](https://dev.epicgames.com/documentation/fortnite/fortnite-creative-glossary). Feel free to landscape the island by removing trees and planting them elsewhere if needed. Find purposes for your valuable water sources.
...
_These GOAT Getaway modifications include (1) an airport for air arrivals and departures, (2) a whale-watching tower, (3) land transportation, and (4) docking for ocean arrivals and departures._
...
Students who are unfamiliar with Fortnite Creative can review Getting Started, [Playing Games](https://dev.epicgames.com/documentation/fortnite/lets-play-in-fortnite-creative), and Building Your First Island on the [Fortnite Creative Documentation](https://dev.epicgames.com/documentation/fortnite/fortnite-creative-documentation) site. Also use the [Fortnite Creative Glossary](https://dev.epicgames.com/documentation/fortnite/fortnite-creative-glossary) for definitions of terms.
  1. Students should begin building their getaway experiences in Fortnite Creative using the Archipelagos Island or XL Archipelagos Island (for multiple students collaborating on a single island) found under [Starter Islands](https://dev.epicgames.com/documentation/fortnite/fortnite-creative-glossary#starter-island).
  2. They can use any and all of the building tools — prefabs, galleries, devices, and more, found in the Creative inventory.
  3. Every few class periods, ask students to reflect on their work and compare it to their initial brainstorming and planning ideas. Introduce the idea of [iterative design](https://dev.epicgames.com/documentation/fortnite/fortnite-creative-glossary#iterate) to help think about the new ideas and changes they are making to their islands.

###  4. Show off your work!
It's time for students to share their work with the class, and online, if they choose.
  1. Create a [video walkthrough](https://dev.epicgames.com/documentation/fortnite/making-thumbnails-and-videos-in-fortnite-creative) or an [image-capture slide deck](https://dev.epicgames.com/documentation/fortnite/promoting-your-fortnite-creative-island) to show your island to the class.
