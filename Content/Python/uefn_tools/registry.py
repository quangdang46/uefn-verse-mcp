...
The ToolRegistry is a singleton. Access it anywhere via:
    from uefn_tools.registry import get_registry
...
class ToolRegistry:
    """
    Central registry for all UEFN uefn_tools tools.
