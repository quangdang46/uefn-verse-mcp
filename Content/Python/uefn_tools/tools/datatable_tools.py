...
@register_tool(
    ...
    description=(
        ...
        "Output saved to Saved/uefn_tools/datatables/{table_name}.json. "
...
def run_datatable_export(asset_path: str = "", output_path: str = "", **kwargs) -> dict:
    ...
    try:
        ...
        if not output_path:
            saved = os.path.join(unreal.Paths.project_saved_dir(), "uefn_tools", "datatables")
