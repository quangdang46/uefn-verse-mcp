"""
uefn_tools — Spline → Verse Converter
========================================
...
FEATURES:
  ...
  • All output written to Saved/uefn_tools/snippets/ and copied to clipboard
...
SNIPPETS_DIR = os.path.join(
    unreal.Paths.project_saved_dir(), "uefn_tools", "snippets"
)
...
def run_spline_to_verse_points(
    ...
    **kwargs,
    ...
    content = f"""\
# Generated by UEFN uefn_tools — Spline to Verse Converter
# {timestamp}
...
def run_spline_to_verse_patrol(
    ...
    **kwargs,
    ...
    timestamp = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    content = f"""\
# Generated by UEFN uefn_tools — Spline to Verse Patrol
# {timestamp}
...
def run_spline_to_verse_zone_boundary(
    ...
    **kwargs,
    ...
    content = f"""\
# Generated by UEFN uefn_tools — Spline to Verse Zone Boundary
# {timestamp}
...
def run_spline_export_json(
    ...
    **kwargs,
    ...
    """
    Exports spline data as JSON to Saved/uefn_tools/spline_export.json.
