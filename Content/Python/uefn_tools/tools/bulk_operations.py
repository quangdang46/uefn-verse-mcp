"""
uefn_tools — Bulk Operations Toolkit
========================================
...
@register_tool(
    ...
    description=(
        ...
        "one draw call instead of N. Saves to /Game/uefn_tools/Merged/ by default."
    ),
    tags=["merge", "static mesh", "optimization", "draw call", "bulk", "performance"],
)
def run_mesh_merge_selection(
    dest_path: str = "/Game/uefn_tools/Merged",
    ...
    **kwargs,
    ...
    Args:
        dest_path:         Content Browser folder for the new asset (default /Game/uefn_tools/Merged)
