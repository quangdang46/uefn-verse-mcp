"""
uefn_tools — Advanced Alignment & Distribution Toolkit
==========================================================
...
def align_to_reference(axis: str = "Z", reference: str = "first", **kwargs) -> dict:
    ...
    aligned = 0
    with unreal.ScopedEditorTransaction("uefn_tools: Align to Reference") as _t:
...
def distribute_with_gap(axis: str = "X", gap: float = 0.0, **kwargs) -> dict:
    ...
    distributed = 0
    with unreal.ScopedEditorTransaction("uefn_tools: Distribute with Gap") as _t:
...
def rotate_around_pivot(
    ...
    **kwargs,
    ...
    rotated = 0
    with unreal.ScopedEditorTransaction("uefn_tools: Rotate Around Pivot") as _t:
...
def align_to_surface(offset_z: float = 0.0, **kwargs) -> dict:
    ...
    snapped = 0
    with unreal.ScopedEditorTransaction("uefn_tools: Align to Surface") as _t:
        try:
...
def match_spacing(axis: str = "X", **kwargs) -> dict:
    ...
    redistributed = 0
    with unreal.ScopedEditorTransaction("uefn_tools: Match Spacing") as _t:
...
def align_to_grid_two_points(grid_size: float = 100.0, **kwargs) -> dict:
    ...
    snapped = 0
    with unreal.ScopedEditorTransaction("uefn_tools: Align to Grid (Two Points)") as _t:
        for actor in targets:
            try:
                loc = actor.get_actor_location()
