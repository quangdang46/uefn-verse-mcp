"""
uefn_tools — Asset Renamer & Naming Convention Enforcer
========================================
...
FEATURES:
  ...
  • Detailed rename report saved to Saved/uefn_tools/rename_report.json
...
BLUEPRINT:
    "Execute Python Command" →
        import uefn_tools as tb; tb.run("rename_dry_run", scan_path="/Game/MyProject")
"""
...
def run_rename_report(scan_path: str = "", **kwargs) -> dict:
    ...
    report to Saved/uefn_tools/rename_report.json.
