...
Tools:
  ...
  api_export_full    — export complete unreal module stubs to Saved/uefn_tools/stubs/
...
Output:
  Saved/uefn_tools/stubs/unreal.pyi   (full module stub)
  Saved/uefn_tools/stubs/<ClassName>.pyi (per-class stub)
  Saved/uefn_tools/api_report.json    (machine-readable index)
"""
...
_SAVED = os.path.join(
    unreal.Paths.project_saved_dir(), "uefn_tools"
)
...
def _module_stub_header() -> str:
    return (
        ...
        f'Generated by UEFN uefn_tools api_explorer on UEFN build: '
        f'{getattr(unreal, "ENGINE_VERSION_STRING", "unknown")}\n'
        '\n'
        'DO NOT EDIT — regenerate with:\n'
        '  import uefn_tools as tb; tb.run("api_export_full")\n'
        '"""\n'
        'from __future__ import annotations\n'
