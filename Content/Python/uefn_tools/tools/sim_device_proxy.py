"""
uefn_tools — Verse Simulation Proxies
========================================
...
def run_generate_proxy(**kwargs) -> dict:
    ...
    lines = [
        f"# Auto-generated by UEFN uefn_tools — sim_generate_proxy",
        f"# Verse class : {v_cls}",
        f"# Actor label : {actor.get_actor_label()}",
        f"# Raw class   : {cls_raw}",
        f"# Usage:",
        f"#   import uefn_tools as tb",
    ...
    out_dir  = os.path.join(unreal.Paths.project_saved_dir(), "uefn_tools", "proxies")
