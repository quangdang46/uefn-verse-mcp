"""
uefn_tools — screenshot_tools.py
=========================================
...
Output folder:
  Saved/uefn_tools/screenshots/  (created on first use)
...
Notes:
  - All screenshots land in Saved/uefn_tools/screenshots/
...
from uefn_tools.core import actors_bounding_box, get_selected_actors
...
@register_tool(
    ...
    category="Screenshot",
    description="Capture the viewport at any resolution to Saved/uefn_tools/screenshots/",
    icon="📷",
...
def screenshot_take(
    ...
    **kwargs,
    ...
    Output:
        Saved/uefn_tools/screenshots/{name}_{YYYYMMDD_HHMMSS}_{W}x{H}.png
    """
