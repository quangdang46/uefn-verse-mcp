"""
uefn_tools — Smart Importer & Organizer
========================================
...
FEATURES:
  ...
  • Generate a JSON import log saved to Saved/uefn_tools/
...
BLUEPRINT:
    "Execute Python Command" →
        import uefn_tools as tb; tb.run("import_fbx", file_path="C:/path/to/mesh.fbx")
"""
...
AUTO_MATERIAL_PARENT = "/Game/uefn_tools/Materials/M_uefn_toolsBase"
