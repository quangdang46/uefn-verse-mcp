"""
uefn_tools — Quick Verse Snippet Generator
========================================
...
FEATURES:
  ...
  • Output to Saved/uefn_tools/snippets/ as .verse files
...
_HEADER = """\
# ============================================================
# Generated by UEFN uefn_tools — Verse Snippet Generator
# {timestamp}
# ============================================================
...
def _find_uefn_project_root() -> str:
    ...
    The uefn_tools lives at [ProjectRoot]/Content/Python/uefn_tools/
...
def _find_verse_project_dir() -> str:
    ...
    4. Falls back to Saved/uefn_tools/snippets/custom/ with a clear warning
...
def run_gen_custom(
    ...
    **kwargs,
    ...
    header = (
        f"# ============================================================\n"
        f"# Generated by UEFN uefn_tools — verse_gen_custom\n"
        f"# {timestamp}\n"
    )
    if description:
...
@register_tool(
    ...
    category="Verse Helpers",
    description="List all generated snippet files in the Saved/uefn_tools/snippets/ folder.",
...
def run_gen_device_declarations(**kwargs) -> dict:
    ...
    timestamp = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    lines = [
        f"# Generated by UEFN uefn_tools — {timestamp}",
