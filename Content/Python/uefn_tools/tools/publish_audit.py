    ...
    **kwargs,
    ...
    Returns:
        {
          ...
          "summary":     str,
          "report_path": str,     # JSON saved to Saved/uefn_tools/publish_audit.json
        }
    ...
    Example:
        ...
        tb.run("publish_audit", required_devices="SpawnPadDevice,EndGameDevice",
               actor_limit=3000)
    """
    toolbelt_saved = os.path.join(unreal.Paths.project_saved_dir(), "uefn_tools")
