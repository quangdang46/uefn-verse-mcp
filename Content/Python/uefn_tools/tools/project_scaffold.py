"""
uefn_tools — Project Scaffold Generator
========================================
...
FEATURES:
  ...
  • Detailed creation log saved to Saved/uefn_tools/scaffold_log.json
...
BLUEPRINT:
    "Execute Python Command" →
        import uefn_tools as tb; tb.run("scaffold_generate", template="uefn_standard", project_name="MyProject")
"""
...
TEMPLATES_FILE = os.path.join(
    unreal.Paths.project_saved_dir(), "uefn_tools", "scaffold_templates.json"
)
...
def run_scaffold_save_template(
    ...
    **kwargs,
    ...
    The template is stored in Saved/uefn_tools/scaffold_templates.json
