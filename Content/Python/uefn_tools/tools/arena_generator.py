...
BLUEPRINT:
    "Execute Python Command" →  import uefn_tools as tb; tb.run("arena_generate", size="medium")
...
MESH_FLOOR     = "/Game/uefn_tools/Meshes/SM_Floor_Tile"
MESH_WALL      = "/Game/uefn_tools/Meshes/SM_Wall_Panel"
MESH_PLATFORM  = "/Game/uefn_tools/Meshes/SM_Platform"
MESH_SPAWN_PAD = "/Game/uefn_tools/Meshes/SM_SpawnPad"
...
# ─────────────────────────────────────────────────────────────────────────────
#  Direct color fallback (no M_uefn_toolsBase required)
# ─────────────────────────────────────────────────────────────────────────────

# Paths where auto-generated team materials are stored.
# Created once on first arena spawn, reused on every subsequent call.
_MAT_RED_PATH  = "/Game/uefn_tools/Materials/M_Arena_TeamRed"
_MAT_BLUE_PATH = "/Game/uefn_tools/Materials/M_Arena_TeamBlue"
_MAT_FOLDER    = "/Game/uefn_tools/Materials"
...
def _apply_team_colors(
    ...
    Creates /Game/uefn_tools/Materials/M_Arena_TeamRed|Blue on first run,
    then reuses them. No custom parent material (M_uefn_toolsBase) required.
    """
