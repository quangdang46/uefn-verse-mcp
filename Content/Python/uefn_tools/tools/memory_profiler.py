"""
uefn_tools — Memory Profiler & Auto-Fixer
========================================
...
FEATURES:
  ...
  • Export full report to Saved/uefn_tools/memory_report.json
...
BLUEPRINT:
    "Execute Python Command" →
        import uefn_tools as tb; tb.run("memory_scan", scan_path="/Game")
"""
...
def run_memory_scan(scan_path: str = "", **kwargs) -> dict:
    ...
    Full results saved to Saved/uefn_tools/memory_report.json.
