"""
uefn_tools — Level Health Dashboard
=======================================
Unified level health report that aggregates results from the uefn_tools's
...
@register_tool(
    ...
    category="Utilities",
    description=(
        "Run all uefn_tools audit tools and return a unified level health score (0–100) "
