"""
uefn_tools — Batch LOD & Collision Tools
========================================
...
BLUEPRINT:
    "Execute Python Command" →
        import uefn_tools as tb; tb.run("lod_auto_generate_folder", folder_path="/Game/Meshes", num_lods=3)
...
def run_lod_audit_folder(
    ...
    **kwargs,
    ...
    """
    Prints a report and saves JSON to Saved/uefn_tools/lod_audit.json.
