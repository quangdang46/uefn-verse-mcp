...
@register_tool(
    ...
    description=(
        ...
        "Output saved to Saved/uefn_tools/curves/curve_export.json. "
...
def run_curve_export(scan_path: str = "/Game/", output_path: str = "", **kwargs) -> dict:
    try:
        ...
        if not output_path:
            saved = os.path.join(unreal.Paths.project_saved_dir(), "uefn_tools", "curves")
