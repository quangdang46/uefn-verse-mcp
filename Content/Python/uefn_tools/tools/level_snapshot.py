...
Storage:
  Saved/uefn_tools/snapshots/<name>.json
...
from uefn_tools.core import undo_transaction, with_progress
...
def snapshot_list(**kwargs) -> dict:
    """
    Print all saved snapshots in Saved/uefn_tools/snapshots/.
