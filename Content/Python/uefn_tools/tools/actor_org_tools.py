"""
uefn_tools — Actor Organization Toolkit
===========================================
...
def actor_attach_to_parent(**kwargs) -> dict:
    ...
    attached = 0
    with unreal.ScopedEditorTransaction("uefn_tools: Attach to Parent") as _t:
...
def actor_detach(**kwargs) -> dict:
    ...
    detached = 0
    with unreal.ScopedEditorTransaction("uefn_tools: Detach Actors") as _t:
...
def actor_move_to_folder(folder_name: str = "Folder", **kwargs) -> dict:
    ...
    moved = 0
    with unreal.ScopedEditorTransaction("uefn_tools: Move Actors to Folder") as _t:
        for actor in selected:
            try:
...
def actor_move_to_root(**kwargs) -> dict:
    ...
    moved = 0
    with unreal.ScopedEditorTransaction("uefn_tools: Move Actors to Root") as _t:
        for actor in selected:
            try:
...
def actor_rename_folder(
    ...
    **kwargs,
    ...
    moved = 0
    with unreal.ScopedEditorTransaction("uefn_tools: Rename Folder") as _t:
...
def actor_match_transform(
    ...
    **kwargs,
    ...
    applied = 0
    with unreal.ScopedEditorTransaction("uefn_tools: Match Transform") as _t:
        for actor in targets:
            try:
