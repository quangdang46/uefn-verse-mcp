...
Start by [creating and naming a new project](https://dev.epicgames.com/documentation/fortnite/starting-and-organizing-a-project-in-fortnite) then adding [Lore Version Control](https://dev.epicgames.com/documentation/fortnite/lore-version-control-in-unreal-editor-for-fortnite). Once the project opens, you can add devices and props to the viewport and save them.

[![Tick the Source Control box to add source control to your projects](https://dev.epicgames.com/community/api/documentation/image/370e1758-2149-4d8f-86c4-be686689a98e?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/370e1758-2149-4d8f-86c4-be686689a98e?resizing_type=fit)
...
[![The Launch Session button.](https://dev.epicgames.com/community/api/documentation/image/de73ce5d-7e30-4e92-b598-078ff6b821c4?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/de73ce5d-7e30-4e92-b598-078ff6b821c4?resizing_type=fit)
...
[![Joining the party of a colleague in UEFN through Fortnite.](https://dev.epicgames.com/community/api/documentation/image/f42e91f0-8709-44d3-be8f-98ac9541084e?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/f42e91f0-8709-44d3-be8f-98ac9541084e?resizing_type=fit)
...
[![invite friend](https://dev.epicgames.com/community/api/documentation/image/a1861a56-a253-4d31-ace2-03a5d5997e69?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/a1861a56-a253-4d31-ace2-03a5d5997e69?resizing_type=fit)

Press the **Tab** key and select **My Island**, then select the **Permissions** tab. Your friend's [gamertag](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#gamertag) will appear on this page once they have joined your party.

[![permissions tab](https://dev.epicgames.com/community/api/documentation/image/d60b7c51-cab2-4e48-88c1-3f04081eaef4?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/d60b7c51-cab2-4e48-88c1-3f04081eaef4?resizing_type=fit)
...
[![friend](https://dev.epicgames.com/community/api/documentation/image/d676ac2a-9495-4c42-845f-f52354a199f0?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/d676ac2a-9495-4c42-845f-f52354a199f0?resizing_type=fit)
...
Launch the Fortnite client and join your friend's [party](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#party). Set the destination to **Creative**. Once all players have [readied up](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#ready-up), press **Play**.

[![Party](https://dev.epicgames.com/community/api/documentation/image/08953688-729c-44d7-bb9c-ee9c77a4d6dc?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/08953688-729c-44d7-bb9c-ee9c77a4d6dc?resizing_type=fit)
...
[![Golden Rift](https://dev.epicgames.com/community/api/documentation/image/6c59ba7c-d6b1-4057-8b8e-241f11a5cf70?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/6c59ba7c-d6b1-4057-8b8e-241f11a5cf70?resizing_type=fit)
...
[![Permissions](https://dev.epicgames.com/community/api/documentation/image/51ef84a7-57f5-4552-90c8-a8657d556c3f?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/51ef84a7-57f5-4552-90c8-a8657d556c3f?resizing_type=fit)
