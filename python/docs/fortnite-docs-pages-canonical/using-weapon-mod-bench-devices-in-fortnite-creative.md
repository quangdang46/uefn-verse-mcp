...
Use the **Weapon Mod Bench** to give your players the ability to customize any [moddable](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#mod) weapons they have by using weapon mods.
