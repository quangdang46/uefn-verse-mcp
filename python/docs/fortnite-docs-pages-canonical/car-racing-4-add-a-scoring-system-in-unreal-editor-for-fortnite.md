...
With all the devices in place, it's time to set up how they interact. Direct event binding allows devices to talk to one another directly by using **events** and **functions**. Learn more about it [here](https://dev.epicgames.com/documentation/fortnite/direct-event-binding-in-unreal-editor-for-fortnite).
...
1. Import a custom applause sound into your project by right-clicking inside the **Content Browser** and selecting **Import to...**. See the [Import Custom Audio](https://dev.epicgames.com/documentation/fortnite/importing-custom-audio-in-unreal-editor-for-fortnite) for more information.
