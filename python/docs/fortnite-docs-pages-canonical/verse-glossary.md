...
Thrown firefly jars will cause any surrounding terrain and structures to take fire damage if **Enable Fire** , **Environment Damage** , and **Structure Damage** are enabled in [My Island Settings](https://dev.epicgames.com/documentation/fortnite/fortnite-creative-glossary).
...
To find the Firefly Spawner device, see [Using Devices](https://dev.epicgames.com/documentation/fortnite/using-devices-in-fortnite).
