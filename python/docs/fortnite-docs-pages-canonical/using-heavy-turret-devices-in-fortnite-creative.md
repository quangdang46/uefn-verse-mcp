...
The **Heavy Turret** is a ground-based version of the turret on the Armored Battle Bus. You can place these devices around your island for players to use to eliminate vehicles, [NPCs](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary), or other players.

For help on how to find the Heavy Turret device, see [Using Devices](https://dev.epicgames.com/documentation/fortnite/using-devices-in-fortnite).
