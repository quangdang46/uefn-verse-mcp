...
This can be useful in [brawl games](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) where you can offer a status [buff](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) to increase the [damage](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) they put out, or to boost their speed.

You can also use it in [skillrun](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary)- or [parkour](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary)-type games where you can raise stakes by forcing players to slip on a surface, making the run more challenging.

For help finding the Grind Powerup device, see [Using Devices](https://dev.epicgames.com/documentation/fortnite/using-devices-in-fortnite).
...
[Default](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) options include a duration of 3 seconds, with 15 seconds until [respawn](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary). These and a number of other options can be customized to suit your [gameplay](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary).
...
| **Spawn On Minigame Start** | **Yes**, No | Determines whether the device will [spawn](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) immediately at the start of a minigame. If set to **No**, the device will spawn only at the respawn time set under **Time To Respond**. |
...
| **Selected Class** | **Any**, Pick a class | Only the selected [class](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) can interact with this device. |
