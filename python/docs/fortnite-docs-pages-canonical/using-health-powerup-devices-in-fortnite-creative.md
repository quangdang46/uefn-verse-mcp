...
The **Health Powerup** device regenerates a player's health, their shields, or their health and shields. You can configure this [power-up](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#power-up) to work in a variety of ways by customizing the device options.

For information on finding the Health Powerup device, see **[Using Devices](https://dev.epicgames.com/documentation/fortnite/using-devices-in-fortnite)**.
