...
The **Nitro Drifter Spawner** is a fast, stylish car that seats four to encourage social play. The visual look of the vehicle is themed around Cyber-City and fits well with a cyberpunk or Neo-Tokyo aesthetic. This car also has unique handling, with the ability to [drift](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#drift). This works particularly well with racing games, but can add style to any game mode where vehicles are available.
