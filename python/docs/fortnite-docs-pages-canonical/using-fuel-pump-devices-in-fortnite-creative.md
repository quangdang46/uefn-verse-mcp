...
You can set the device to be indestructible during gameplay, or deal damage to a certain team or [class](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) of player. For example:
...
- In [skillrun](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) games, players have to complete a task before they can use the device.

For help on how to find the **Fuel Pump** device, see [Using Devices](https://dev.epicgames.com/documentation/fortnite/using-devices-in-fortnite).
