...
You can then import this .usd file into UE to [convert it to a cloth asset](https://dev.epicgames.com/documentation/fortnite/create-your-clothing-asset-in-unreal-engine-in-unreal-editor-for-fortnite).
