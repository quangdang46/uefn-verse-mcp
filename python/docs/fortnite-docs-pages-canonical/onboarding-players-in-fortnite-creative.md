...
You'll find beacons in the **Beacon Gallery** on the [Galleries tab](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) instead of as a device on the [Devices tab](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary). There are a variety of beacons to select from. You can also customize a beacon after adding it to your island.
...
[Playtest](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#playtest) frequently to ensure that all of your informational devices are working when and how you expect them to.
