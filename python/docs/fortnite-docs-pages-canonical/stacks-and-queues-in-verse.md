...
You can represent the elements in a stack using any ordered data structure, such as an array or a [linked list](https://dev.epicgames.com/documentation/fortnite/linked-lists-in-verse). In this example, you’ll use an array since it gives you easy access to the top of the stack.
