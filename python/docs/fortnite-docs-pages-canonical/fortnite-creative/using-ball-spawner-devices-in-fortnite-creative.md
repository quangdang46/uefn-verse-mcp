...
The **Ball Spawner** device [spawns](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) a ball at the start of the game. This ball is relatively light by default, and can be knocked around by players. It will be consumed when it touches a [capture area](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary).
...
To find the Ball Spawner device, see [Using Devices](https://dev.epicgames.com/documentation/fortnite/using-devices-in-fortnite).
