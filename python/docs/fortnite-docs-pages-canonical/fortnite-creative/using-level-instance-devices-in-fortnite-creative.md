...
The **Level Instance** device is a [volume](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#volume) where you can place structures and props, then save the collection. If you need multiple groups of items that are all the same, you can copy and paste the device to place that grouping wherever you need it.
...
For help finding the **Level Instance** device, see [Using Devices](https://dev.epicgames.com/documentation/fortnite/using-devices-in-fortnite).
