...
To find the **Air Vent** device, see [Using Devices](https://dev.epicgames.com/documentation/fortnite/using-devices-in-fortnite).
...
Looking for more inspiration? See [Air Vent Device Design Examples](https://dev.epicgames.com/documentation/fortnite/using-air-vent-device-design-examples-in-fortnite-creative) to boost your imagination!
