...
Offer **Produce** [items](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) to replenish your player’s damaged [health](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#health). These items can refill up to 15 health points, either instantly or incrementally.
...
For example, you can require **Pepper** and **[Animal Bones](https://dev.epicgames.com/documentation/fortnite/using-crafting-items-in-fortnite-creative)** as items needed to craft **Meat**.
