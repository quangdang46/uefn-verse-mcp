...
- In the toolbar, navigate to the **Selection Mode** dropdown and select **Fortnite Tools**.
  ...
  [![](https://dev.epicgames.com/community/api/documentation/image/d9fb3a81-e75c-4317-9aa0-03fd4bdda3f9?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/d9fb3a81-e75c-4317-9aa0-03fd4bdda3f9?resizing_type=fit)

  Click to enlarge image.

You can also switch to Fortnite Tools using the keyboard shortcut **Shift+6**. To learn more about the various modes, see **[Level Editor Mode](https://dev.epicgames.com/documentation/unreal-engine/BlueprintAPI/LevelEditor?application_version=5.6)**.
...
[![An example of the Create Volume tool and its options.](https://dev.epicgames.com/community/api/documentation/image/a29c25df-0a63-406c-b23f-ede0ea96569f?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/a29c25df-0a63-406c-b23f-ede0ea96569f?resizing_type=fit)
...
| AI Navigation Volume | A volume that constrains the movement of AI characters. | [The AI Navigation volume.](https://dev.epicgames.com/community/api/documentation/image/eddec637-f705-4955-8bf7-89d5df3188e8?resizing_type=fit)  Click image to enlarge. |
| Barrier Volume | A barrier that can contain or block:Players accessWeapon fireWildlifeNPCs | [The Barrier volume.](https://dev.epicgames.com/community/api/documentation/image/1fd4412b-cf10-400b-905c-8d59cb89477d?resizing_type=fit)  Click image to enlarge. |
| Crowd Volume | Places a crowd of NPC characters. | [The Crowd volume.](https://dev.epicgames.com/community/api/documentation/image/4285f0cc-2353-4659-8981-ac2d3173f489?resizing_type=fit)  Click image to enlarge. |
| Damage Volume | Deals damage to players, wildlife, NPCs, and more. | [The Damage volume.](https://dev.epicgames.com/community/api/documentation/image/b27cd50f-06fe-4ba2-8daf-2841da7c729b?resizing_type=fit)  Click image to enlarge. |
| Emote Volume | A volume that causes the player to emote. | [The Emote volume.](https://dev.epicgames.com/community/api/documentation/image/6021be8e-83d5-42a5-8547-f979e524508e?resizing_type=fit)  Click image to enlarge. |
| Fire Volume | A volume that has fire and causes fire damage. | [The Fire volume.](https://dev.epicgames.com/community/api/documentation/image/2fd4decc-c8e8-44fb-8071-3839623031a0?resizing_type=fit)  Click image to enlarge. |
| Mutator Volume | A volume that causes devices to change states. | [The Mutator volume.](https://dev.epicgames.com/community/api/documentation/image/88acc6e0-d04d-488f-a634-f4e8d98fec4c?resizing_type=fit)  Click image to enlarge. |
| Skydive Volume | Players use their skydive settings whil ein this volume. | [The Skydive volume.](https://dev.epicgames.com/community/api/documentation/image/0c361b76-331d-4850-838f-a85594b48bc4?resizing_type=fit)  Click image to enlarge. |
| Volume | A volume that contains players, wildlife, and NPCs. | [A Volume.](https://dev.epicgames.com/community/api/documentation/image/976c2393-6eac-4c70-b118-270371e14573?resizing_type=fit)  Click image to enlarge. |
| Blocking Volume | A volume that blocks players, wildlife, and NPCs. | [The Blocking volume.](https://dev.epicgames.com/community/api/documentation/image/9c9e4b60-4a72-4299-b61b-fe32d3119f78?resizing_type=fit)  Click image to enlarge. |
| Post Process Volume | A post processing effect for the area the volume occupies. | [The Post Process volume](https://dev.epicgames.com/community/api/documentation/image/9d552621-3b16-47d1-ad7a-c760e36d5195?resizing_type=fit)  Click image to enlarge. |
| Fort Underground Volume | Creates a space that can be turned into a cave and sit beneath the landscaping. | [The Fort Underground volume.](https://dev.epicgames.com/community/api/documentation/image/bd431b3f-2379-4184-8e8e-32fb4f09fa4d?resizing_type=fit)  Click image to enlarge. |
| Fort Water Body Exclusion | A volume | [Fort Body Exclusion volume.](https://dev.epicgames.com/community/api/documentation/image/520fbd02-a2c6-4c80-a933-be9eb10a516d?resizing_type=fit)  Click image to enlarge. |
...
[![An example of overlapping actors in the Find Overlap tool.](https://dev.epicgames.com/community/api/documentation/image/fec484c1-16ed-4bf7-9c3b-effe804dc352?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/fec484c1-16ed-4bf7-9c3b-effe804dc352?resizing_type=fit)

Click image to enlarge.

Find Overlap has four main actions:

[![An example of the Find Overlap tools.](https://dev.epicgames.com/community/api/documentation/image/451f58e3-d090-44e0-822a-a3ad436f4b8e?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/451f58e3-d090-44e0-822a-a3ad436f4b8e?resizing_type=fit)
...
[![The Helper Asset and its tools.](https://dev.epicgames.com/community/api/documentation/image/e5ecb0eb-f07d-4095-b639-4c79d0319f43?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/e5ecb0eb-f07d-4095-b639-4c79d0319f43?resizing_type=fit)
...
- **Select Physics** - 
  When clicked, this button removes any objects that are not Physics objects from the selection. This only affects the current selection in the Editor. If nothing is selected, nothing will occur.
- **Select Non Physics** - 
  When clicked, this button removes any objects that are a Physics object from the current selection. This only affects the current selection in the Editor. If nothing is selected, nothing will occur.
...
[![An example of the Scatter tools.](https://dev.epicgames.com/community/api/documentation/image/c96b5482-120f-447b-9fb6-4fc3e927805b?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/c96b5482-120f-447b-9fb6-4fc3e927805b?resizing_type=fit)
...
[![An example of the Snap to Target tools.](https://dev.epicgames.com/community/api/documentation/image/06ad51ca-f6da-43ad-bb64-34c79f371479?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/06ad51ca-f6da-43ad-bb64-34c79f371479?resizing_type=fit)
...
[![An example of the 3D Select tools.](https://dev.epicgames.com/community/api/documentation/image/82ccbaed-cc34-423b-8cb5-8330f3ba084e?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/82ccbaed-cc34-423b-8cb5-8330f3ba084e?resizing_type=fit)
...
As you resize the bounding box, objects that are fully enclosed will be selected and highlighted in the viewport and [Outliner](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#outliner-panel).

When you finish selecting, exit the tool by pressing **Esc,** or by clicking **Complete** in the viewport. With all assets selected in the bounding box you can use another asset action such as **Grouping**, or use the [Snap To Target](https://dev.epicgames.com/documentation/fortnite/fortnite-tools-mode-in-fortnite#snap-to-target-nbsp) tool for quick asset duplication and placement in the level.
...
[![Only objects with the word FastFood in the Include Label are selected.](https://dev.epicgames.com/community/api/documentation/image/53b8db4b-0b98-4bec-b244-a411ae2fd1b0?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/53b8db4b-0b98-4bec-b244-a411ae2fd1b0?resizing_type=fit)
...
Fix the issues outlined in Tool Information, then test your meshes again to ensure the issues have been resolved. See the **[Memory and Optimization](https://dev.epicgames.com/documentation/fortnite/memory-and-optimization-in-unreal-editor-for-fortnite)** documentation to learn more about optimizing your assets.
...
[![](https://dev.epicgames.com/community/api/documentation/image/0e9b039b-bfac-4810-9d12-37459ab396e6?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/0e9b039b-bfac-4810-9d12-37459ab396e6?resizing_type=fit)

Click to enlarge image.

[![](https://dev.epicgames.com/community/api/documentation/image/a88b0bf8-3539-4570-bc60-0c77afb31604?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/a88b0bf8-3539-4570-bc60-0c77afb31604?resizing_type=fit)

Click to enlarge image.

Travel Time has six main options:

[![An example of the Travel Time tools.](https://dev.epicgames.com/community/api/documentation/image/7430f0db-f367-4c2d-b83f-6696f6269d89?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/7430f0db-f367-4c2d-b83f-6696f6269d89?resizing_type=fit)
...
- **Shortcuts** - Provides shortcuts for the following Travel Time tools:
  ...
  - **Move Segment** - Causes Transform widgets to appear at all major Travel Time Splines.
    ...
    [![](https://dev.epicgames.com/community/api/documentation/image/4dffd09e-8179-460b-83da-7369477edae1?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/4dffd09e-8179-460b-83da-7369477edae1?resizing_type=fit)
...
- **Appearance** - Controls the appearance of the segments in the viewport using the following controls:
  ...
  - **Segment Line Thickness** - Changes the segment line thickness.
    ...
    [![](https://dev.epicgames.com/community/api/documentation/image/9ca579c0-9a9a-40ec-bb07-60e34226c6b8?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/9ca579c0-9a9a-40ec-bb07-60e34226c6b8?resizing_type=fit)
...
[![An example of the Travel Time tool options.](https://dev.epicgames.com/community/api/documentation/image/c26cca3e-b830-4b69-b553-7be6b8dfa911?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/c26cca3e-b830-4b69-b553-7be6b8dfa911?resizing_type=fit)
