...
The **Hiding Prop Gallery** provides you with several different [props](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#prop) that players can hide in and teleport through:
...
You can use these to create a [hide-and-seek](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#hide-and-seek) game that is different from a [prop hunt](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#prop-hunt). You can customize the props so that more than one player can hide in one, and determine whether the prop has sound effects and a wobbling animation when it is occupied.
