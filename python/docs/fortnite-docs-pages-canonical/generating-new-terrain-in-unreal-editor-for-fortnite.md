...
Continue making your custom terrain by learning how to use the [Sculpt tools](https://dev.epicgames.com/documentation/fortnite/sculpting-the-terrain-in-unreal-editor-for-fortnite).
