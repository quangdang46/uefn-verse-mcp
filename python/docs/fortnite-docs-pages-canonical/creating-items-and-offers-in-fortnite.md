...
[![A packet of corn seeds.](https://dev.epicgames.com/community/api/documentation/image/4dd96e26-5cf4-4c42-bbf7-88ee9cb0da3e?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/4dd96e26-5cf4-4c42-bbf7-88ee9cb0da3e?resizing_type=fit)
...
[![](https://dev.epicgames.com/community/api/documentation/image/2164229d-43ef-4911-b6d5-309d7362f9c7?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/2164229d-43ef-4911-b6d5-309d7362f9c7?resizing_type=fit)
...
Do not use Fortnite Item Shop terms for items or progression markers like "XP". Players should never be confused about whether they are purchasing items that can be used across all of Fortnite or only within your island.   
  
For more details on terms and naming guidelines for In-Island Monetization, see [Terms and Naming](https://dev.epicgames.com/documentation/fortnite/guidelines-for-in-island-monetization-in-fortnite#terms-and-naming).
...
[![An alternate to the previous corn seed packet. It is a hessian-style sack container instead.](https://dev.epicgames.com/community/api/documentation/image/eacd0877-d7e8-47c6-8fee-bbe0fb90f530?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/eacd0877-d7e8-47c6-8fee-bbe0fb90f530?resizing_type=fit)
...
[![Two corn seed packets bundled together with rope.](https://dev.epicgames.com/community/api/documentation/image/fd6c8a7e-1419-4017-90e1-7baef1170f80?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/fd6c8a7e-1419-4017-90e1-7baef1170f80?resizing_type=fit)
...
[![An icon for the multi-offer bundle that contains a shovel and 10 corn seed packets.](https://dev.epicgames.com/community/api/documentation/image/9d196a30-b20d-46fb-97e1-e876b53caedf?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/9d196a30-b20d-46fb-97e1-e876b53caedf?resizing_type=fit)
...
[![](https://dev.epicgames.com/community/api/documentation/image/d96138b6-cca4-4f47-8b41-1b012d2dc172?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/d96138b6-cca4-4f47-8b41-1b012d2dc172?resizing_type=fit)
...
[![](https://dev.epicgames.com/community/api/documentation/image/236eb35e-4d3d-4bd6-8a75-d1275f67d931?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/236eb35e-4d3d-4bd6-8a75-d1275f67d931?resizing_type=fit)
...
![Corn Seed Pack Bundle Offer Panel](https://dev.epicgames.com/community/api/documentation/image/52b17783-7d8a-403b-b0e4-d4d6b518fb6e?resizing_type=fit&width=1920&height=1080)

![Corn Seed Pack Bundle Offer Inspection Panel](https://dev.epicgames.com/community/api/documentation/image/91cdbc9e-f10f-4cd0-9478-0013f1df7c9b?resizing_type=fit&width=1920&height=1080)
...
When creating an item that grants a random reward directly or that can only be redeemed for a random reward, you must set `PaidRandomItem` to true for that entitlement and disclose the accurate numerical odds of obtaining each possible random item prior to its purchase. Disclose the accurate numerical odds of obtaining each possible random item directly in the offer description or explain in the offer description where the odds can be viewed.
...
 If you offer content that can be redeemed for various items, including a random reward, you must use the `RestrictPaidRandomItems` function to prevent players without access from acquiring the random reward. You must disclose the accurate numerical odds of obtaining each possible item before a player can obtain the random reward.
...
If there is an alternative to the item you are selling that provides the same advantage and is freely available to all players at the same time the offer is presented with no conditions, then you do not need to set `ConsequentialToGameplay` to **true**. This means players must be able to access the item without completing specific tasks or meeting gameplay requirements.

If an item has an incidental but inconsequential impact on gameplay, as is the case with different colored items that have the same gameplay but slightly different visibilities in different environments, you do not need to set `ConsequentialToGameplay` to true.
