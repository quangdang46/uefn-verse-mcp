...
| **Assigns Driver When Receiving From** | Sets the player that [instigated](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#instigator) the signal as the spawned vehicle's rider |
