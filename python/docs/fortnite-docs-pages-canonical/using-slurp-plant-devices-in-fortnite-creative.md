...
![Slurp Plant Devices](https://dev.epicgames.com/community/api/documentation/image/8b71e545-eff7-438b-93a7-5d6ec113f56d?resizing_type=fill&width=1920&height=335)
...
- Give players more ways to interact with your [game mechanics](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#game-mechanics).
...
For help on how to find the **Slurp Plant** device, see [Using Devices](https://dev.epicgames.com/documentation/fortnite/using-devices-in-fortnite).
...
Below you can find the [functions](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#function) and [events](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#event) for this device.
