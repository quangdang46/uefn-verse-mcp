...
**Castle** [galleries](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#gallery) share [themes](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#island-theme) of fortress and mansion structures and props.

In the **Galleries** [category](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#category), you can browse for building pieces to make unique structures. The Galleries tab also offers environmental and prop items.
