...
A **Pickup Truck Spawner** is a device that [spawns](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#spawning) a pickup truck vehicle into your island at the spawner's given location and orientation.

- Use Pickup Truck Spawner devices in combination with the [Race Checkpoint Device](https://dev.epicgames.com/documentation/fortnite/using-race-checkpoint-devices-in-fortnite-creative) to design a racing game for your players.
- You can place a player directly inside the pickup truck using a trigger.

To find the **Pickup Truck Spawner** device, see [Using Devices](https://dev.epicgames.com/documentation/fortnite/using-devices-in-fortnite).
