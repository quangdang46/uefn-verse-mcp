...
This device has some basic functionality, like whether the spawner is visible during the game. Additionally, there are some advanced options, like how much [health](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#health) the vehicle has and which team can access the vehicle.
