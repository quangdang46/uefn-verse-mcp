...
AI
:   See [artificial intelligence](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#artificial-intelligence).
...
auction
:   An auction is a daily, UTC-aligned process that ranks eligible Sponsored Row [campaigns](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#campaign) by [CPM](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#cpm) bid to allocate available impressions using a [second-price](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#secondprice-auction-model) model.
...
binding
:   When you bind two devices together, you establish a way to trigger one or more [functions](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#function) based on a signal from another device called an [event](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#event). Events can be used to define player attributes, trigger specific actions, and customize gameplay in other ways.
...
bundle offer
:   For in-island transactions, a bundle offer is a grouping of [offers](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#item-offer), with a quantity for each item in the group, that can be purchased as a single unit. Examples could include **100 arrows** or **100 arrows + 50 potions**.

    A bundle offer might have only one item but include a quantity of that single item to represent a [stack](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#stack) of items.
...
campaign
:   A [Sponsored Row](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#sponsored-row) campaign is a time-bound, bid-based object linking a developer’s island to a scheduled daily budget and max bid for prioritizing placement in Discover.

campaign ID
:   A unique identifier per campaign used for support and reporting in a Sponsored Row [campaign](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#campaign).
...
concurrent users
:   See [CCU](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#ccu).
...
consumable item
:   For in-island transactions, with a consumable item, the player receives a defined quantity that is decremented (reduced) on consumption. This could apply to a single [offer](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#item-offer) (with an item of 1) or a [bundle offer](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#bundle-offer) (with multiple offers).
...
cost per mille
:   See [CPM](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#cpm).
...
CPM
:   Cost per mille (CPM) is the cost per 1,000 impressions in a [Sponsored Row](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#sponsored-row) campaign.
...
:   In Fortnite, durability refers to a gameplay mechanic where some weapons, tools, or other items have a limited lifespan, and break after a certain time or use. Some game modes allow the player to repair these broken items, while in other modes, they cannot be repaired.
    ...
    Durability should not be confused with a [durable item](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#durable-product).
...
:   For in-island transactions, when a player acquires a durable item, they permanently own it. For example, this could be a furniture item in a game that involves building a house.
    ...
    A durable product should not be confused with [durability](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#durability).
...
:   For in-island transactions, 
    any purchasable item, whether consumable or [durable](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#durable-product), is an offer when it's made available to the player. Examples could include an arrow, or a single item of furniture in a game that involves building a house.
...
Epic ecosystem
:   See [Fortnite ecosystem](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#fortnite-ecosystem).
...
:   The estimated number of [impressions](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#impression) expected in a Sponsored Row [campaign](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#campaign) based on duration, budget, and bid.
...
invoice
:   A snapshot of the full offer that is presented to a specific player. It includes a final price. The invoice can only be purchased once and will expire after a short time. If purchased successfully, the invoice info will be propagated to the [purchase record](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#purchase-record).
...
meter materials
:   Materials used in a progress bar UI. The material parameters can be set in Verse and [UMG](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#umg).
...
Paid Area
:   An [offer](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#item-offer) that provides access behind a paywall. An example would be access to a backstage area in a narrative-type game.
...
Trigger
:   **(v)** To trigger a device is to activate it either through direct interaction or by use of [binding](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#binding).
