...
Read the updated [Memory Management documentation](https://dev.epicgames.com/documentation/fortnite/memory-management-in-unreal-editor-for-fortnite) for optimization tips.

This enforcement follows the [v37.00 update](https://dev.epicgames.com/documentation/fortnite/37-00-fortnite-ecosystem-updates-and-release-notes), which moved memory calculation to cook-time data for faster, more accurate results and expanded support for more asset types and Scene Graph.
