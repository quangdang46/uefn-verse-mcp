...
Converting to these brand islands requires a manual setup of specific project components. To convert away from any of the brands listed below, refer to the [Converting away from a Brand Island](https://dev.epicgames.com/documentation/fortnite/converting-your-island-into-a-brand-island-in-fortnite#converting-away-from-a-brand-island) section.
