...
Thrown firefly jars will cause any surrounding terrain and structures to take fire damage if **Enable Fire**, **Environment Damage**, and **Structure Damage** are enabled in [My Island Settings](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary).
