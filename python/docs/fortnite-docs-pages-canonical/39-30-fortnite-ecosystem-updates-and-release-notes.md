...
The new optimization tools (Textures and Static Mesh) can help you quickly find and solve optimization issues that can create bloat in your project and potentially cause quality issues for players. See the [Fortnite Tools Mode](https://dev.epicgames.com/documentation/fortnite/fortnite-tools-mode-in-fortnite) document for examples and more information on the new tools.
