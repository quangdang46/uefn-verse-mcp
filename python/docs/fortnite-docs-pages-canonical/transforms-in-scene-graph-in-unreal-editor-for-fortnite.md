...
The transform_component is a Verse class defined in the `/Verse.org/SceneGraph` module that stores a Scene Graph entity's LocalTransform and, optionally, an alternative Origin. You can think of the transform_componentas a container supplied to an entity for a transform that defines its place in the simulation.
