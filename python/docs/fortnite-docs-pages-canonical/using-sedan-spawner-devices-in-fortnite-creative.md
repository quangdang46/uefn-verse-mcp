...
The **Sedan Spawner** is a device that [spawns](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#spawning) a sedan vehicle your island at the spawner's given location and orientation.

- Use Sedan Spawner devices in combination with the [Race Checkpoint Device](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#race-checkpoint) to design a racing game for your players.
- You can place a player directly inside the sedan using a trigger.

For help on how to find the **Sedan Spawner** device, see [Using Devices](https://dev.epicgames.com/documentation/fortnite/using-devices-in-fortnite).
...
This device has some basic functionality, like boost [regen](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#regen) and whether the radio is [enabled](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#enable). Additionally, there are some advanced options, like whether the sedan vehicle takes damage from [collisions](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary), how much damage it can take before being destroyed, and how much damage it deals when it explodes.
...
| Option | Value | Description |
| --- | --- | --- |
| **Assigns Driver When Receiving From** | **No Channel**, Pick a channel | Sets the player that [instigated](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#instigator) the signal as the spawned vehicle's driver |
