...
This device creates a zone that, when triggered, will switch a player to a different class. Used with the Class Designer, the Class Selector is used for a single class.
