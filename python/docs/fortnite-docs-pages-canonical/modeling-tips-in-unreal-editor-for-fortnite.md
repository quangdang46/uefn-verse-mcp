...
To ensure that you’re working with the right scale, see [Creating Fortnite-Ready Assets in UEFN](https://dev.epicgames.com/documentation/fortnite/fortniteready-assets-best-practices-in-fortnite) for more on units, scale, and grid sizing.
...
See the [Asset Troubleshooting](https://dev.epicgames.com/documentation/fortnite/fortniteready-assets-best-practices-in-fortnite) section from Creating Fortnite-Ready Assets in UEFN for a list of possible issues you might encounter when creating assets for UEFN.
