...
For help on how to find the **Roly Poly** device, see [Using Devices](https://dev.epicgames.com/documentation/fortnite/using-devices-in-fortnite) .
...
Following are the **[event binding](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#direct-event-binding)** options for this device.
