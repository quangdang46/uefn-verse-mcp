...
These prefabs can be found under the [Creative Contents tab](https://dev.epicgames.com/documentation/fortnite/fortnite-creative-glossary) in the Prefabs category.
...
Students who are unfamiliar with Fortnite Creative can review the pages under [Starting Out in Fortnite Creative](https://dev.epicgames.com/documentation/fortnite/get-started-creating-in-fortnite).
Also use the [Fortnite Creative Glossary](https://dev.epicgames.com/documentation/fortnite/fortnite-creative-glossary) for definitions of terms.
  1. Students should begin building their Sustainable Stacks solution in Fortnite Creative using the Greasy Grove Island found under [Starter Islands](https://dev.epicgames.com/documentation/fortnite/fortnite-creative-glossary#starter-island).
...
It’s time for students to share their work with the class and online, if they choose.
  1. Create a [video walkthrough](https://dev.epicgames.com/documentation/fortnite/making-thumbnails-and-videos-in-fortnite-creative) or an image-capture slide deck to show your island to the class.
