...
To add a component to your entity, refer to [**Working with Entities and Components**](https://dev.epicgames.com/documentation/fortnite/working-with-entites-and-components-in-unreal-editor-for-fortnite#addingacomponent). The component is listed as **sound_component** , which matches the Verse class for the mesh component. For more information about the Verse API for the sound component, check out the [sound_component API reference](https://dev.epicgames.com/documentation/en-us/uefn/verse-api/unrealenginedotcom/temporary/scenegraph/sound_component).
##  Example
...
[![](https://dev.epicgames.com/community/api/documentation/image/a67b1b1c-b8d2-4064-b649-9843e1308b44?resizing_type=fit)](https://dev.epicgames.com/community/api/documentation/image/a67b1b1c-b8d2-4064-b649-9843e1308b44?resizing_type=fit)
  ...
  4. Select **sound_component** , then select the MetaSound asset you would like to use as a component.
    1. You can also reference the MetaSound through the [**Audio Player**](https://dev.epicgames.com/documentation/fortnite/audio-player-in-unreal-editor-for-fortnite) device.
