...
A **Helicopter Spawner** is a device that [spawns](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#spawning) a Helicopter vehicle into the level at the spawner's given location and orientation.

- Use Helicopter Spawner devices in combination with the [Race Checkpoint Device](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary#race-checkpoint) to design a racing game for your players.
