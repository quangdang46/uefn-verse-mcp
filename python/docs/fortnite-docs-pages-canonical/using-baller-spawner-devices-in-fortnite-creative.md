...
A **Baller Spawner** is a device that [spawns](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) a [Baller](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) vehicle into the level at the spawner's given location and orientation.

Some ideas for using the Baller:

- Use Baller Spawner devices in combination with the [Racing Checkpoint Device](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) to design a racing game for your players.
...
| --- | --- | --- |
| **Enabled During Phase** | **All**, None, Pre-Game Only, Gameplay Only, Create Only | Determines the game [phases](https://dev.epicgames.com/documentation/fortnite/fortnite-glossary) during which the device will be enabled. Pre-Game includes all phases that occur before the game starts. |
