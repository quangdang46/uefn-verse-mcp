...
To add a component to your entity, refer to [**Working with Entities and Components**](working-with-entites-and-components-in-unreal-editor-for-fortnite#addingacomponent). The component is listed as **sound_component**, which matches the Verse class for the mesh component. For more information about the Verse API for the sound component, check out the [sound_component API reference](https://dev.epicgames.com/documentation/en-us/uefn/verse-api/unrealenginedotcom/temporary/scenegraph/sound_component).
