...
Learn technical details about the (InEntity:entity).GetGlobalTransform extension.
...
`(InEntity:entity).GetGlobalTransform<public><native>()<transacts>:`[`transform`](https://dev.epicgames.com/documentation/fortnite/verse-api/versedotorg/spatialmath/transform)
