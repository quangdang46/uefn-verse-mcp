...
Learn technical details about the interactable_duration class.
...
| --- | --- |
| [`GetRemainingInteractDurationForAgent`](https://dev.epicgames.com/documentation/fortnite/verse-api/versedotorg/scenegraph/interactable_duration/getremaininginteractdurationforagent) | Returns an agent’s remaining duration, in seconds, for interaction. Fails if the agent is not interacting with this component.Returns the same value when called multiple times within a transaction. |
| [`SetRemainingInteractDurationForAgent`](https://dev.epicgames.com/documentation/fortnite/verse-api/versedotorg/scenegraph/interactable_duration/setremaininginteractdurationforagent) | Sets an agent’s remaining duration, in seconds, for interaction. Fails if the agent is not interacting with this component. |
