...
Learn technical details about the (InEntity:entity).GetOrigin extension.
...
`(InEntity:entity).GetOrigin<public><native>()<transacts><decides>:`[`origin`](https://dev.epicgames.com/documentation/fortnite/verse-api/versedotorg/scenegraph/origin)
