...
Learn technical details about the SendDown function.
...
`SendDown<public><native><native_callable><final>(SceneEvent:scene_event)<transacts><no_rollback>:logic`
...
The following specifiers determine how you can interact with `SendDown` in your programs. For the complete list of specifiers, see the [Specifiers Page](https://dev.epicgames.com/documentation/fortnite/specifiers-and-attributes-in-verse).
...
The following effects determine how `SendDown` behaves in your programs. For the complete list of effects, see the Effect Specifers section of the [Specifiers Page](https://dev.epicgames.com/documentation/fortnite/specifiers-and-attributes-in-verse).
