...
`operator'*'<public><native>(Vector:vector3, Rotation:rotation)<reads>:`[`vector3`](https://dev.epicgames.com/documentation/fortnite/verse-api/versedotorg/spatialmath/vector3)
