...
`(V:vector3).MakeUnitVector<public>()<reads><computes><decides>:`[`vector3`](https://dev.epicgames.com/documentation/fortnite/verse-api/unrealenginedotcom/temporary/spatialmath/vector3)
