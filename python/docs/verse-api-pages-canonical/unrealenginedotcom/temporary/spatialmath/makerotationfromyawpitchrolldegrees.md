...
`MakeRotationFromYawPitchRollDegrees<public><native>(YawRightDegrees:float, PitchUpDegrees:float, RollClockwiseDegrees:float):`[`rotation`](https://dev.epicgames.com/documentation/fortnite/verse-api/unrealenginedotcom/temporary/spatialmath/rotation)
