...
`(Rotation:rotation).RotateVector<public><native>(Vector:vector3):`[`vector3`](https://dev.epicgames.com/documentation/fortnite/verse-api/unrealenginedotcom/temporary/spatialmath/vector3)
