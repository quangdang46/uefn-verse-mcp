...
`ReflectVector<public>(Direction:vector3, SurfaceNormal:vector3)<reads><computes><decides>:`[`vector3`](https://dev.epicgames.com/documentation/fortnite/verse-api/unrealenginedotcom/temporary/spatialmath/vector3)
...
The following effects determine how `ReflectVector` behaves in your programs. For the complete list of effects, see the Effect Specifers section of the [Specifiers Page](https://dev.epicgames.com/documentation/fortnite/specifiers-and-attributes-in-verse).
