...
`(InitialRotation:rotation).UnrotateBy<public><native>(RotationToRemove:rotation)<transacts>:`[`rotation`](https://dev.epicgames.com/documentation/fortnite/verse-api/unrealenginedotcom/temporary/spatialmath/rotation)
