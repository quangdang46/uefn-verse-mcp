...
`MakeRotation<public><native>(Axis:vector3, AngleRadians:float):`[`rotation`](https://dev.epicgames.com/documentation/fortnite/verse-api/unrealenginedotcom/temporary/spatialmath/rotation)
