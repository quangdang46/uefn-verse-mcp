...
`(InitialRotation:rotation).ApplyPitch<public><native>(PitchUpRadians:float)<transacts>:`[`rotation`](https://dev.epicgames.com/documentation/fortnite/verse-api/unrealenginedotcom/temporary/spatialmath/rotation)
