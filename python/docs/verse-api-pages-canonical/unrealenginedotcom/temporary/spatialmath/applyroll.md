...
`(InitialRotation:rotation).ApplyRoll<public><native>(RollClockwiseRadians:float)<transacts>:`[`rotation`](https://dev.epicgames.com/documentation/fortnite/verse-api/unrealenginedotcom/temporary/spatialmath/rotation)
