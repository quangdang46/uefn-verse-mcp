...
`(InCharacter:fort_character).GetVehicle<public><native>()<transacts><decides>:`[`fort_vehicle`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/vehicles/fort_vehicle)
