...
| Name | Description |
| --- | --- |
| [`elimination_result`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/game/elimination_result) | Result data for `fort_character` elimination events. |
| [`damage_args`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/game/damage_args) | Parameters for common damage functions on Fortnite objects. |
| [`damage_result`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/game/damage_result) | Results for damage events on Fortnite objects. |
| [`healing_args`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/game/healing_args) | Parameters for common healing functions on Fortnite objects. |
| [`healing_result`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/game/healing_result) | Results for healing events on Fortnite objects. |

## Interfaces

| Name | Description |
| --- | --- |
| [`fort_round_manager`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/game/fort_round_manager) | This interface is implemented by the round manager living on the simulation entity. |
