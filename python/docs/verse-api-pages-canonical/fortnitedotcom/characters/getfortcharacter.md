...
`(InAgent:agent).GetFortCharacter<public><native>()<transacts><decides>:`[`fort_character`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/characters/fort_character)
