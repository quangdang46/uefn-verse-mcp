...
`(InAgent:agent).GetNPCBehavior<public><native>()<transacts><decides>:`[`npc_behavior`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/ai/npc_behavior)
