...
`(InCharacter:fort_character).GetFocusInterface<public>()<transacts><decides>:`[`focus_interface`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/ai/focus_interface)
