...
---|---
[`GetMood`](https://dev.epicgames.com/documentation/en-us/fortnite/verse-api/fortnitedotcom/ai/npc_sidekick_component/getmood) |  Get the Sidekick's current mood.
