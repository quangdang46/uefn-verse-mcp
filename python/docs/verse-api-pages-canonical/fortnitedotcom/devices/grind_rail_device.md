...
| --- | --- |
| [`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/grind_rail_device/disable) | Disables this device, preventing players from grinding on the rail. |
| [`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/grind_rail_device/enable) | Enables this device, letting players grind on the rail. |
...
| [`Hide`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/grind_rail_device/hide) | Hides the track. Players can still grind on the track if it is enabled. |
...
| [`SetRailColor`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/grind_rail_device/setrailcolor) | Sets the color of the Grind Rail. |
| [`Show`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/grind_rail_device/show) | Make this track visible. |
