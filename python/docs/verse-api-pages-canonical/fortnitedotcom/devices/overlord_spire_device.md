...
| [`Destroy`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/overlord_spire_device/destroy) | Sets the Spire's health to zero, destroying it.   - Does nothing if the Spire has not spawned or is already destroyed. |
| [`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/overlord_spire_device/disable) | Disable the device which causes the Spire to become deactivated, stopping the behaviors and attacks, as well as preventing activation when players are within the `Activation Distance`.   - Does nothing if the Spire is destroyed or already disabled. |
| [`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/overlord_spire_device/enable) | Enable the device, causing the Spire to become activated when players are within the `Activation Distance`.   - Does nothing if the Spire is destroyed or already enabled. |
...
| [`Spawn`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/overlord_spire_device/spawn) | Spawns the Spire, causing it to become visible and enabling collision   - Does nothing if the Spire is already spawned or destroyed |
