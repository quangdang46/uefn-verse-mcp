...
| [`GetMagnitude`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/damage_amplifier_powerup_device/getmagnitude) | Returns the current *Magnitude* for the powerup. For the Damage Amplifier Powerup, this is the damage multiplier. |
