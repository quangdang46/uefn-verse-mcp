...
| --- | --- |
| [`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/rift_point_volume_device/disable) | Disables the device, preventing the Rift Point from being planted. |
| [`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/rift_point_volume_device/enable) | Enables the device, allowing the Rift Point to be planted. |
| [`GetAgentsInVolume`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/rift_point_volume_device/getagentsinvolume) | Returns an array of agents that are currently occupying the volume. |
...
| [`IsEnabled`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/rift_point_volume_device/isenabled) | Succeeds if the component is enabled, fails if it’s disabled. |
| [`IsInVolume`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/rift_point_volume_device/isinvolume) | Is true when `Agent` is in the volume. |
