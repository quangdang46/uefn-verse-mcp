...
| --- | --- |
| [`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/fishing_zone_device/disable) | Disables this device. |
| [`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/fishing_zone_device/enable) | Enables this device. |
...
| [`Reset`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/fishing_zone_device/reset) | Resets the number of available uses for this device back to *Uses Allowed*. |
| [`Restock`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/fishing_zone_device/restock) | Returns all caught and removed items to the inventory. This only works when *Pool Type* is set to *Device Inventory*. |
