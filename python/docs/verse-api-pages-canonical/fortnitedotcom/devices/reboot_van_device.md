...
| --- | --- |
| [`DisableReboot`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/reboot_van_device/disablereboot) | Disable the device. |
| [`EnableReboot`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/reboot_van_device/enablereboot) | Enable the device. |
...
| [`IsEnabledReboot`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/reboot_van_device/isenabledreboot) | Succeeds if the device is enabled, fails if it's disabled. |
