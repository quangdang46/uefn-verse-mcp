...
| --- | --- |
| [`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/vine_rail_device/disable) | Disables this device, preventing players from grinding on the vines. |
| [`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/vine_rail_device/enable) | Enables this device, letting players grind on the vines. |
...
| [`Hide`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/vine_rail_device/hide) | Hides the track. Players can still grind on the track if it is enabled. |
...
| [`Show`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/vine_rail_device/show) | Make this track visible. |
