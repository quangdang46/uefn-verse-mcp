...
| [`Pause`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/animated_mesh_device/pause) | Pauses playback of the animation. |
| [`Play`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/animated_mesh_device/play) | Starts or resumes playback of the animation. |
| [`PlayReverse`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/animated_mesh_device/playreverse) | Starts or resumes reverse playback of the animation. |
