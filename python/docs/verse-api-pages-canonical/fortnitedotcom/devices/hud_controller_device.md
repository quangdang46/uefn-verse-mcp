...
| --- | --- |
| [`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/hud_controller_device/disable) | Disables this device. |
| [`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/hud_controller_device/enable) | Enables this device. |
...
| [`ResetAffectedClass`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/hud_controller_device/resetaffectedclass) | Resets the *Affected Class* option to its starting value. |
| [`ResetAffectedTeam`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/hud_controller_device/resetaffectedteam) | Resets the *Affected Team* option to its starting value. |
...
| [`UpdateAffectedClass`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/hud_controller_device/updateaffectedclass) | Sets the *Affected Class* option to `Agent`'s class. |
| [`UpdateAffectedTeam`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/hud_controller_device/updateaffectedteam) | Sets the *Affected Team* option to `Agent`'s team. |
