...
| --- | --- |
| [`ChangeClass`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/class_and_team_selector_device/changeclass) | Changes the `Agent`'s class. |
| [`ChangeSelectorTeam`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/class_and_team_selector_device/changeselectorteam) | Changes the selecting team. |
| [`ChangeTeam`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/class_and_team_selector_device/changeteam) | Changes the `Agent`'s team. |
| [`ChangeTeamAndClass`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/class_and_team_selector_device/changeteamandclass) | Changes the `Agent`'s team and class. |
| [`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/class_and_team_selector_device/disable) | Disables this device. |
| [`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/class_and_team_selector_device/enable) | Enables this device. |
