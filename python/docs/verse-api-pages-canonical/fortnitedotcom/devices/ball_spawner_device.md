...
| [`HideHUD`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/ball_spawner_device/hidehud) | Hides the floating HUD Icons from players, if these have been configured by the device. |
...
| [`ShowHUD`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/ball_spawner_device/showhud) | Shows the floating HUD Icons to players, if these have been configured by the device. |
