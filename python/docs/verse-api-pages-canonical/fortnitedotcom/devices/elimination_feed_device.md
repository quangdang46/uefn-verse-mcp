...
| --- | --- |
| [`Activate`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/elimination_feed_device/activate) | Activates this device. `Agent` is used as the instigator of the action. |
| [`Activate`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/elimination_feed_device/activate-1) | Activates this device. Requires *Activated by Team / Class* be set to `All`. |
| [`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/elimination_feed_device/disable) | Disables this device. |
| [`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/elimination_feed_device/enable) | Enables this device. |
