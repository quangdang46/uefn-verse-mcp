...
| [`gameplay_controls_device`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/gameplay_controls_device) | Used to update the gameplay controls scheme based on current control mode. |
...
| --- | --- |
| [`AddTo`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/gameplay_controls_device/addto) | Adds the gameplay control to the `Player`'s gameplay controls stack and pushes it to be the active control. |
| [`AddToAll`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/gameplay_controls_device/addtoall) | Adds the gameplay control to all `Agent`s gameplay controls stack and pushes it to be the active control. |
| [`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/gameplay_controls_device/disable) | Disables this device. |
| [`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/gameplay_controls_device/enable) | Enables this device. |
...
| [`RemoveFrom`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/gameplay_controls_device/removefrom) | Removes the gameplay control from the `Agent`'s gameplay controls stack and pops from being the active control replacing it with the next one in the stack. |
| [`RemoveFromAll`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/gameplay_controls_device/removefromall) | Removes the gameplay control from all `Agent`s gameplay controls stack and pops from being the active control replacing it with the next one in the stack. |
