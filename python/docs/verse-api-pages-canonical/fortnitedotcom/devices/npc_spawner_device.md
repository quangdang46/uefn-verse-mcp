...
| [`SetNPCCharacterDefinition`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/npc_spawner_device/setnpccharacterdefinition) | Set the NPC character definition to use. Fails if the character type is different from one in the current definition. |
