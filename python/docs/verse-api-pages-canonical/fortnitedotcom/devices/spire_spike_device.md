...
| --- | --- |
| [`ChargeKnockback`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/spire_spike_device/chargeknockback) | Force begins the knockback charge timer. Will restart the charge timer if already active. |
| [`Despawn`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/spire_spike_device/despawn) | Despawns the Spire Spike. It will not drop loot. |
| [`Destroy`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/spire_spike_device/destroy) | Destroy the Spire Spike. Will cause the Spire Spike to drop its loot. |
...
| [`IsSpawned`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/spire_spike_device/isspawned) | Returns if Spire Spike is currently spawned. |
| [`Knockback`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/spire_spike_device/knockback) | Force the Spire Spike to trigger its knockback ability immediately. |
...
| [`Spawn`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/spire_spike_device/spawn) | Spawn the Spire Spike. Resets CurrentHealth back to max health. Resets any timers currently active. |
