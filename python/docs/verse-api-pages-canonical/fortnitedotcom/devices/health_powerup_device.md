...
| [`GetMagnitude`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/health_powerup_device/getmagnitude) | Returns the current *Magnitude* for the powerup. For the Health Powerup, this is the amount of health or shield that the powerup will add or remove, |
