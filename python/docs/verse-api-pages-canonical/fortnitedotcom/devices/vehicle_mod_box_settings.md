...
| --- | --- |
| [`ApplyDefaultVisuals`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/vehicle_mod_box_settings/applydefaultvisuals) | Reset visual settings and make the associated mod box use its default non-customized visuals.   - Fails if this is a custom list entry set to `Empty Slot`. |
