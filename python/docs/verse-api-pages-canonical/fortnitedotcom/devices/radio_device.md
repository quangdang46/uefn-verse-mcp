...
| [`Hide`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/radio_device/hide) | Hides this device from the world. |
...
| [`Play`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/radio_device/play) | Starts playing audio from this device. |
| [`Register`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/radio_device/register) | Adds the specified agent as a target for the Radio to play audio from |
...
| [`Show`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/radio_device/show) | Shows this device in the world. |
| [`Stop`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/radio_device/stop) | Stops playing audio from this device. |
...
| [`Unregister`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/radio_device/unregister) | Removes the specified agent as a target for the Radio to play audio from if previously Registered |
| [`UnregisterAll`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/radio_device/unregisterall) | Removes all previously registered agents as targets for the Radio to play audio from |
