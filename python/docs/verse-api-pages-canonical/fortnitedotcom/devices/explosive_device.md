...
| --- | --- |
| [`Explode`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/explosive_device/explode) | Triggers this device to explode. Passes `Agent` as the instigator of the resulting `ExplodedEvent`. |
...
| [`Hide`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/explosive_device/hide) | Hides this device from the world. |
...
| [`Reset`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/explosive_device/reset) | Resets this device. |
...
| [`Show`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/explosive_device/show) | Shows this device in the world. |
