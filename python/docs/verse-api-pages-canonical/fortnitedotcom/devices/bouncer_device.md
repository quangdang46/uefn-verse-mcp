...
| --- | --- |
| [`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/bouncer_device/disable) | Disables bouncing on this device, as well as any visual and audio effects. |
| [`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/bouncer_device/enable) | Enables bouncing on this device, as well as any visual and audio effects. |
