...
| --- | --- |
| [`GetClassMembers`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/class_designer_device/getclassmembers) | Returns an array of agents that are currently of *Class* defined by this device. |
...
| [`IsOfClass`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/class_designer_device/isofclass) | Is true if `Agent` is on *Class* defined by this device. |
