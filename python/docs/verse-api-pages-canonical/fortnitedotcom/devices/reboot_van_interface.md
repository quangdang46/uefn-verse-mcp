...
| --- | --- |
| [`EnableReboot`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/reboot_van_interface/enablereboot) | Enable the device. |
| [`DisableReboot`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/reboot_van_interface/disablereboot) | Disable the device. |
| [`IsEnabledReboot`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/reboot_van_interface/isenabledreboot) | Succeeds if the device is enabled, fails if it's disabled. |
