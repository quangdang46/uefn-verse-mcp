...
| --- | --- |
| [`Activate`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/movement_modulator_device/activate) | Activates this device's movement effect on `Agent`. |
| [`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/movement_modulator_device/disable) | Disables this device. |
| [`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/movement_modulator_device/enable) | Enables this device. |
