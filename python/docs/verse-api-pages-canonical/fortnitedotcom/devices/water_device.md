...
| --- | --- |
| [`BeginVerticalEmptying`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/water_device/beginverticalemptying) | Starts vertically emptying the water in the volume. |
| [`BeginVerticalFilling`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/water_device/beginverticalfilling) | Starts vertically filling the water in the volume. |
| [`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/water_device/disable) | Disables this device. |
| [`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/water_device/enable) | Enables this device. |
...
| [`Reset`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/water_device/reset) | Resets the water level in the volume to the value set in the *Default Vertical Water Percentage* option. |
| [`ResumeVerticalMovement`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/water_device/resumeverticalmovement) | Resumes either filling or emptying the volume. |
...
| [`StopVerticalMovement`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/water_device/stopverticalmovement) | Stops filling or emptying the volume. |
