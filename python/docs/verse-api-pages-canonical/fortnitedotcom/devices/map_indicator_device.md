...
| --- | --- |
| [`ActivateObjectivePulse`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/map_indicator_device/activateobjectivepulse) | Activates an objective pulse at `Agent`'s location pointing toward this device. |
| [`DeactivateObjectivePulse`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/map_indicator_device/deactivateobjectivepulse) | Deactivates the objective pulse at `Agent`'s location. |
| [`Disable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/map_indicator_device/disable) | Disables this device. |
| [`Enable`](https://dev.epicgames.com/documentation/fortnite/verse-api/fortnitedotcom/devices/map_indicator_device/enable) | Enables this device. |
