...
```bash
curl -fsSL https://raw.githubusercontent.com/quangdang46/uefn-verse-mcp/legacy/python/install.sh | bash
```
...
```bash
# uv (recommended)
uv tool install verse-docs-mcp --from "git+https://github.com/quangdang46/uefn-verse-mcp.git@legacy#subdirectory=python"

# pipx
pipx install "git+https://github.com/quangdang46/uefn-verse-mcp.git@legacy#subdirectory=python"

# pip
pip install "git+https://github.com/quangdang46/uefn-verse-mcp.git@legacy#subdirectory=python"
```
